...
public abstract class GradleStartCommon
{
    ...
    static final File       SRG_DIR       = new File("F:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_snapshot_nodoc/20171003/srgs");
    static final File       SRG_NOTCH_SRG = new File("F:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_snapshot_nodoc/20171003/1.12.2/srgs/notch-srg.srg");
    static final File       SRG_NOTCH_MCP = new File("F:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_snapshot_nodoc/20171003/1.12.2/srgs/notch-mcp.srg");
    static final File       SRG_SRG_MCP   = new File("F:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_snapshot_nodoc/20171003/1.12.2/srgs/srg-mcp.srg");
    static final File       SRG_MCP_SRG   = new File("F:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_snapshot_nodoc/20171003/1.12.2/srgs/mcp-srg.srg");
    static final File       SRG_MCP_NOTCH = new File("F:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_snapshot_nodoc/20171003/1.12.2/srgs/mcp-notch.srg");
    static final File       CSV_DIR       = new File("F:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_snapshot_nodoc/20171003");
